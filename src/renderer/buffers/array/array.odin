...
Init :: proc() -> (arr: VertexArray) {
    ...
    OpenGL.VertexAttribPointer(0, 3, OpenGL.FLOAT, OpenGL.FALSE, 10 * size_of(f32), 0)
    OpenGL.EnableVertexAttribArray(1)
    OpenGL.VertexAttribPointer(1, 4, OpenGL.FLOAT, OpenGL.FALSE, 10 * size_of(f32), 3 * size_of(f32))
    OpenGL.EnableVertexAttribArray(2)
    OpenGL.VertexAttribPointer(2, 2, OpenGL.FLOAT, OpenGL.FALSE, 10 * size_of(f32), 7 * size_of(f32))
    OpenGL.EnableVertexAttribArray(3)
    OpenGL.VertexAttribPointer(3, 1, OpenGL.FLOAT, OpenGL.FALSE, 10 * size_of(f32), 9 * size_of(f32))
